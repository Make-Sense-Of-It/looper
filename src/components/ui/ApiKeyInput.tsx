...
const ApiKeyInput: React.FC = () => {
  ...
  const displayValue =
    isEditing || showFullKey ? inputValue : truncateApiKey(inputValue);
        ...
        <Dialog.Root>
          ...
          <Dialog.Content style={{ maxWidth: 450 }}>
            ...
            <Dialog.Description size="2">
              You need an API key from either Claude or OpenAI in order to use
              this service. You can generate one by visiting{" "}
              <Link
                href="https://openai.com/platform"
                target="_blank"
              ...
              . <br />
              <br />
              Note, that there is no free tier for the API!
            </Dialog.Description>
